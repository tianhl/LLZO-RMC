...
\vspace{0.3cm} & \vspace{0.3cm} \\
 ...
 & \noindent\large{Haolai Tian,$^{\ast,a,b,c}$}
 Guanqun Cai,$^{e}$
 Lei Tan,$^{e}$
 Andy Fiedler,$^{d}$
 Anthony E Phillip,$^{e}$
 ...
 David A Keen,$^{g}$
 Dean Keeble,$^{h}$
Martin T. Dove,\textit{$^{i,j,\ddag1}$}
and Xiang Yang Kong,$^{b, \ddag2}$
...
\footnotetext{\textit{$^{d}$~School of Materials Sciences and Engineering, Shanghai Jiao Tong University, Huashan Road 1954, Shanghai 200030, People's Republic of China}}
\footnotetext{\textit{$^{e}$~School of Physics and Astronomy, Queen Mary University of London, Mile End Road, London, E1 4NS, United Kingdom}}
\footnotetext{\textit{$^{f}$~School of Biological and Chemical Sciences, Queen Mary University of London, Mile End Road, London, E1 4NS, United Kingdom}}
\footnotetext{\textit{$^{g}$~ISIS Neutron and Muon Facility,  Rutherford Appleton Laboratory, Harwell Campus, Didcot, Oxfordshire, OX11 0QX, United Kingdom}}
\footnotetext{\textit{$^{h}$~Diamond Light Source Ltd, Harwell Science and Innovation Campus, Didcot, OX11 0DE, United Kingdom}}
...
\footnotetext{\textit{$^{\ddag1}$~Corresponding author. email: martin.dove@icloud.com}}
\footnotetext{\textit{$^{\ddag2}$~Corresponding author. email: xykong@sjtu.edu.cn}}
...
\caption{Neutron scattering function $S(Q)$ for all temperatures.
A constant offset has been applied to separate those curves.
...
\caption{Synchrotron scattering function $S(Q)$ for all temperatures.
A constant offset has been applied to separate those curves.
In each case the data are shown as circles,
and RMC modelling are represented by the solid black lines.}
\label{fig:xsoq}
...
\caption{The distributions calculated from RMCProfile of (1) Li-O, (2)O-O, (3)O-Zr, (4)O-La at low-$r$ range for all temperatures.
A constant offset has been applied to separate those curves.
In each case the RMC modelling are shown as circles,
and the solid black lines indicate the values obtained from Molecular Dynamic simulation}
